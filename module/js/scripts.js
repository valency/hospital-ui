...
//			if($(this).attr('id') == 'queryTypePatientCommonInfoAgeTr'){
//				var qryCondition = {};
//				qryCondition.id = 'queryTypePatientCommonInfoAge';
//				if($.trim($(this).find('#minAge').val()) != ""){
//					qryCondition.minAge =$.trim($(this).find('#minAge').val())
//				}
//				 
//				if($.trim($(this).find('#maxAge').val()) != ""){
//					qryCondition.maxAge =$.trim($(this).find('#maxAge').val())
//				}
//				
//				console.log(qryCondition);
//				curModuleQryConditions.push(qryCondition);
...
//			if($(this).attr('id') == 'queryTypePatientCommonInfoSexTr'){
//				var qryCondition = {};
//				qryCondition.id = 'queryTypePatientCommonInfoSex';
//				if($(this).find('label.checked').attr('data-id')=='1'){
//					qryCondition.isMale =true;
//				}else{
//					qryCondition.isMale =false;
//				}
//				
//				console.log(qryCondition);
//				curModuleQryConditions.push(qryCondition);
...
//			
//			
//			if($(this).attr('id') == 'queryTypePatientCommonInfoBuildTimeTr'){
//				if($.trim($('#inputDate').val()).length == 23){
//					var dates =  $.trim($('#inputDate').val()).split(" 至 ");
//					var qryCondition = {};
//					qryCondition.id = 'queryTypePatientCommonInfoBuildTime';
//					qryCondition.minTime =moment(dates[0]).toDate().getTime();
//					qryCondition.maxTime =moment(dates[1]).toDate().getTime();
//					console.log(qryCondition);
//					curModuleQryConditions.push(qryCondition);
...
//			
//			
//			if($(this).attr('id') == 'queryTypeOutpMrChiefComplainTr'){
//				if($.trim($('#chiefComplaintTxt').val()) != ""){
//					var qryCondition = {};
//					qryCondition.id = 'queryTypeOutpMrChiefComplain';
//					qryCondition.txt =$.trim($('#chiefComplaintTxt').val());
//					console.log(qryCondition);
//					curModuleQryConditions.push(qryCondition);
//					
//				}
			...
			if($(this).hasClass('radio')){
				...
				if(typeof($(this).attr("data-field")) != "undefined"){
					...
					if($(this).hasClass('checked')){
						...
						if(curFieldType.type == 'num'){
							$('#qryConditonTb').append('<tr data-id="'+$(this).attr("data-field")+'"><td class="cNo" width="50"></td><td width="105">'+$('li.activeTab').text()+'</td><td>'+$(this).text()+'： <input type="text" data-id="min" class="text w50" />-<input type="text" data-id="max" class="text w50" /></td></tr>');
						}else if(curFieldType.type == 'bool'){
							$('#qryConditonTb').append('<tr data-id="'+$(this).attr("data-field")+'"><td class="cNo" width="50"></td><td width="105">'+$('li.activeTab').text()+'</td><td>'+$(this).text()+'： <label class="checkbox radio checked"  data-id="y">'+curFieldType.y+'</label><label class="checkbox radio"  data-id="n">'+curFieldType.n+'</label></td></tr>');
						}else if(curFieldType.type == 'time'){
							$('#qryConditonTb').append('<tr data-id="'+$(this).attr("data-field")+'"><td class="cNo" width="50"></td><td width="105">'+$('li.activeTab').text()+'</td><td>'+$(this).text()+'： <input type="text" class="text w200 time" value="" data-time="'+$(this).attr("data-field")+'"/></td></tr>');
							...
							$('#qryConditonTb').append('<tr data-id="'+$(this).attr("data-field")+'"><td class="cNo" width="50"></td><td width="105">'+$('li.activeTab').text()+'</td><td>'+$(this).text()+'：<input data-val="'+$(this).attr("data-field")+'" type="text" class="text w120" /></td></tr>');
						}
...
//				if($(this).attr('id') == 'queryTypePatientCommonInfoAge'){
//					if($("#queryTypePatientCommonInfoAge").hasClass('checked')){
//						console.log('checked');
//						// add age
//						$('#qryConditonTb').append('<tr id="queryTypePatientCommonInfoAgeTr"><td class="cNo" width="50"></td><td width="105">病人基本信息</td><td>年龄： <input type="text" id="minAge" class="text w50" />-<input type="text" id="maxAge" class="text w50" /></td></tr>');
//						var cnos=$("#qryConditonTb").find("td.cNo");
//						cnos.each(function(index){
//							$(this).text('条件'+(index+1));
//						});
//					}else{
//						console.log('unChecked');
//						$('#queryTypePatientCommonInfoAgeTr').remove();
//						var cnos=$("#qryConditonTb").find("td.cNo");
//						cnos.each(function(index){
//							$(this).text('条件'+(index+1));
//						});
//					}
//				}
//				if($(this).attr('id') == 'queryTypePatientCommonInfoSex'){
//					if($("#queryTypePatientCommonInfoSex").hasClass('checked')){
//						console.log('checked');
//						// add age
//						$('#qryConditonTb').append('<tr id="queryTypePatientCommonInfoSexTr"><td class="cNo" width="50"></td><td width="105">病人基本信息</td><td>性别： <label class="checkbox radio checked" name="sex" data-id="1">男</label><label class="checkbox radio" name="sex" data-id="2">女</label></td></tr>');
//						var cnos=$("#qryConditonTb").find("td.cNo");
//						cnos.each(function(index){
//							$(this).text('条件'+(index+1));
//						});
//					}else{
//						console.log('unChecked');
//						$('#queryTypePatientCommonInfoSexTr').remove();
//						var cnos=$("#qryConditonTb").find("td.cNo");
//						cnos.each(function(index){
//							$(this).text('条件'+(index+1));
//						});
...
//				
//				
//				if($(this).attr('id') == 'queryTypePatientCommonInfoBuildTime'){
//					if($("#queryTypePatientCommonInfoBuildTime").hasClass('checked')){
//						console.log('checked');
//						// add age
//						$('#qryConditonTb').append('<tr id="queryTypePatientCommonInfoBuildTimeTr"><td class="cNo" width="50"></td><td width="105">病人基本信息</td><td>建档日期时间： <input type="text" class="text w200 time" value="" id="inputDate"/></td></tr>');
//						//$('#inputDate').val(moment().format('YYYY-MM-DD'));
//						$('#inputDate').daterangepicker(
//								{
//									startDate: moment().subtract('days', 29),//开始选中的时间，29天前
//									endDate: moment().subtract('days', 1),//结束选中的时间，昨天
//									minDate: moment().subtract('days', 30),//'01/01/2012',可选择最早时间，30天前
//									maxDate: moment().subtract('days', 1),//'12/31/2014',可选择最晚时间，昨天
//									dateLimit: { days: 60 },
//									timePickerIncrement: 1,
//									opens: 'right',
//									buttonClasses: ['btn btn-default'],
...
//					}else{
//						console.log('unChecked');
//						$('#queryTypePatientCommonInfoBuildTimeTr').remove();
//						var cnos=$("#qryConditonTb").find("td.cNo");
//						cnos.each(function(index){
//							$(this).text('条件'+(index+1));
//						});
...
//				
//				
//				if($(this).attr('id') == 'queryTypeOutpMrChiefComplain'){
//					if($("#queryTypeOutpMrChiefComplain").hasClass('checked')){
//						console.log('checked');
//						// add age
//						$('#qryConditonTb').append('<tr id="queryTypeOutpMrChiefComplainTr"><td class="cNo" width="50"></td><td width="105">病历</td><td>主诉：<input id="chiefComplaintTxt" type="text" class="text w120" /></td></tr>');
//						var cnos=$("#qryConditonTb").find("td.cNo");
//						cnos.each(function(index){
//							$(this).text('条件'+(index+1));
//						});
//					}else{
//						console.log('unChecked');
//						$('#queryTypeOutpMrChiefComplainTr').remove();
//						var cnos=$("#qryConditonTb").find("td.cNo");
//						cnos.each(function(index){
//							$(this).text('条件'+(index+1));
//						});
...
//				}
//				
//				//result add by billchien
//				
					if($(this).hasClass('checked')){
						console.log('checked');
						// add age
						//<li>诊断: &lt; 诊断名称 &gt;<em class="del"></em></li>
