                ...
                if(typeof($(this).attr("data-field")) != "undefined"){
                    ...
                    if($(this).hasClass('checked')){
                        ...
                        if(curFieldType.type == 'num'){
                            ...
                            $('#qryConditonTb').append('<tr data-id="'+$(this).attr("data-field")+'"><td class="cNo" width="80px"></td><td width="105">'+$('li.activeTab').text()+'</td><td>'+$(this).text()+'： <input type="text" class="form-control time" style="width:220px;" value="" data-time="'+$(this).attr("data-field")+'"/></td></tr>');
